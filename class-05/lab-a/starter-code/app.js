...
where the first element is the sum of those numbers, and the second element is a concatenated string that EXACTLY 
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition, use your sum() function, and to do multiplicationResult, use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to use the + operator for string concatenation.
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (let i = 0; i < sumArr.length; i++) {
    arrSumResult = sum(arrSumResult, sumArr[i])[0];
  }
  return[arrSumResult, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${arrSumResult} is their sum.`];
}
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplicationResult, use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this. This function should handle an array containing three elements. However, you may continue to use the + operator for string concatenation.
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (let i = 0; i < multArr.length; i++) {
    arrMulResult = multiply(arrMulResult, multArr[i])[0];
  }
  return[arrMulResult,`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${arrMulResult}.`];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  let multiplyAnyArrayResult = 1;
  let statementMiddle = '';
  let statement = '';

  for (let i= 0; i < dynamicArray.length ;i++){
    multiplyAnyArrayResult = multiply(multiplyAnyArrayResult, dynamicArray[i])[0];
    statementMiddle = statementMiddle + dynamicArray[i] + ',';
  }

  statement = 'The numbers ' + statementMiddle.slice(0, -1) + ' have a product of ' +  multiplyAnyArrayResult +'.';
  return [multiplyAnyArrayResult, statement];
}
